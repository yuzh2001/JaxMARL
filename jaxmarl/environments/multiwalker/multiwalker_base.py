...
class State:
    # walkers: chex.Array
    # package: chex.Array
    # fallen_walkers: chex.Array
    # game_over: chex.Array
    step: int
    walker_hull_angle_s: chex.Array
    walker_hull_angular_velocity_s: chex.Array
    walker_x_velocity_s: chex.Array
    walker_y_velocity_s: chex.Array
    walker_hip_joint_1_angle_s: chex.Array
    walker_hip_joint_1_speed_s: chex.Array
    walker_knee_joint_1_angle_s: chex.Array
    walker_knee_joint_1_speed_s: chex.Array
    walker_leg_1_ground_contact_flag_s: chex.Array
    walker_hip_joint_2_angle_s: chex.Array
    walker_hip_joint_2_speed_s: chex.Array
    walker_knee_joint_2_angle_s: chex.Array
    walker_knee_joint_2_speed_s: chex.Array
    walker_leg_2_ground_contact_flag_s: chex.Array
    lidar_sensor_readings_s: chex.Array
    left_neighbor_relative_x_position_s: chex.Array
    left_neighbor_relative_y_position_s: chex.Array
    right_neighbor_relative_x_position_s: chex.Array
    right_neighbor_relative_y_position_s: chex.Array
    walker_x_position_relative_to_package_s: chex.Array
    walker_y_position_relative_to_package_s: chex.Array
    package_angle_s: chex.Array
...
class JaxMultiWalkerEnv(MultiAgentEnv):
    def __init__(
        self,
        n_walkers=3,
        position_noise=1e-3,
        ...
        super().__init__(num_agents=n_walkers)
        self._env = MultiWalkerEnv(
            n_walkers=n_walkers,
